...
export default function EmptyState({
  ...
  return (
    ...
    >
      {icon ? (
        <div className="mx-auto mb-4 flex h-12 w-12 items-center justify-center rounded-2xl bg-white text-[var(--color-panel-dark)] shadow-[0_10px_28px_rgba(15,23,42,0.06)]">
          {icon}
        </div>
      ) : null}
